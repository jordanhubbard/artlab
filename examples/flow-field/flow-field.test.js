...
describe('flow-field', () => {
  ...
  it('setup() creates particle position arrays', () => {
    mod.setup(ctx)
    expect(ctx._px).toBeInstanceOf(Float32Array)
    expect(ctx._py).toBeInstanceOf(Float32Array)
    expect(ctx._alpha).toBeInstanceOf(Float32Array)
  })
