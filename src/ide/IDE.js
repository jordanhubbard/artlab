...
const EXAMPLES = [
  ...
  { name: 'color-fields', entry: 'color-fields.js', description: 'A 20x20 animated grid of emissive color planes creating a flowing generative color wave.' },
  ...
  { name: 'fractal-tree', entry: 'fractal-tree.js', description: 'A recursive 3D L-system fractal tree that grows branch by branch from a seed over 10 seconds' },
  ...
  { name: 'orbital-dance', entry: 'orbital-dance.js', description: 'Five colored spheres orbit a luminous sun, trailing ghost paths — a choreography of light.' },
  ...
  { name: 'typography-art', entry: 'typography-art.js', description: 'A neon digital-art poster: glowing ARTLAB logotype over a dark grid, with cycling quote subtitles.' },
